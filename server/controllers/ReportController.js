...
export const getTableTwoReport = async (req, res) => {
    try {
        ...
        for (const [migrant, migrantCode] of Object.entries(migrantCodes)) {
            data[0][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 1 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[0][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 1 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[0][`total`] = result?.filter(item => Number(item.household_member_no) === 1 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[1][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 2 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[1][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 2 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[1][`total`] = result?.filter(item => Number(item.household_member_no) === 2 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[2][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 3 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[2][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 3 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[2][`total`] = result?.filter(item => Number(item.household_member_no) === 3 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[3][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 4 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[3][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 4 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[3][`total`] = result?.filter(item => Number(item.household_member_no) === 4 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[4][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 5 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[4][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 5 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[4][`total`] = result?.filter(item => Number(item.household_member_no) === 5 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[5][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 6 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[5][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 6 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[5][`total`] = result?.filter(item => Number(item.household_member_no) === 6 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[6][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 7 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[6][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 7 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[6][`total`] = result?.filter(item => Number(item.household_member_no) === 7 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[7][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 8 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[7][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 8 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[7][`total`] = result?.filter(item => Number(item.household_member_no) === 8 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[8][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 9 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[8][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 9 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[8][`total`] = result?.filter(item => Number(item.household_member_no) === 9 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[9][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) === 10 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[9][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) === 10 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[9][`total`] = result?.filter(item => Number(item.household_member_no) === 1 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
            
            data[10][`${migrant}Male`] = result?.filter(item => Number(item.household_member_no) > 10 && Number(item.Q36) === migrantCode && Number(item.Q3) === 1)?.length || 0;
            data[10][`${migrant}Female`] = result?.filter(item => Number(item.household_member_no) > 10 && Number(item.Q36) === migrantCode && Number(item.Q3) === 2)?.length || 0;
            data[10][`total`] = result?.filter(item => Number(item.household_member_no) > 10 && [1, 2, 3].includes(Number(item.Q36)) && [1, 2].includes(Number(item.Q3)))?.length || 0;
        }
...
export const getTableThirtyTwoReport = async (req, res) => {
    try {
        ...
        for (const [parent, parentCode] of Object.entries(soloParent)) {
            residentCodes.map((resident, idx) => {
                data[0][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 10 && Number(item.Q4) <= 14 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[0][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 10 && Number(item.Q4) <= 14 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[0][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 10 && Number(item.Q4) <= 14 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                    [1, 2].includes(Number(item.Q3)))?.length || 0;

                data[1][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 15 && Number(item.Q4) <= 19 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[1][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 15 && Number(item.Q4) <= 19 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[1][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 15 && Number(item.Q4) <= 19 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[2][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 20 && Number(item.Q4) <= 24 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[2][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 20 && Number(item.Q4) <= 24 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[2][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 20 && Number(item.Q4) <= 24 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[3][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 25 && Number(item.Q4) <= 29 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[3][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 25 && Number(item.Q4) <= 29 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[3][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 25 && Number(item.Q4) <= 29 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[4][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 30 && Number(item.Q4) <= 34 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[4][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 30 && Number(item.Q4) <= 34 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[4][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 30 && Number(item.Q4) <= 34 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[5][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 35 && Number(item.Q4) <= 39 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[5][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 35 && Number(item.Q4) <= 39 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[5][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 35 && Number(item.Q4) <= 39 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[6][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 40 && Number(item.Q4) <= 44 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[6][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 40 && Number(item.Q4) <= 44 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[6][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 40 && Number(item.Q4) <= 44 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[7][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 45 && Number(item.Q4) <= 49 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[7][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 45 && Number(item.Q4) <= 49 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[7][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 45 && Number(item.Q4) <= 49 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[8][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 50 && Number(item.Q4) <= 54 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[8][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 50 && Number(item.Q4) <= 54 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[8][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 50 && Number(item.Q4) <= 54 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[9][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 55 && Number(item.Q4) <= 59 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[9][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 55 && Number(item.Q4) <= 59 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[9][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 55 && Number(item.Q4) <= 59 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[10][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 60 && Number(item.Q4) <= 64 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[10][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 60 && Number(item.Q4) <= 64 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[10][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 60 && Number(item.Q4) <= 64 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[11][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 65 && Number(item.Q4) <= 69 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[11][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 65 && Number(item.Q4) <= 69 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[11][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 65 && Number(item.Q4) <= 69 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[12][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 70 && Number(item.Q4) <= 74 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[12][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 70 && Number(item.Q4) <= 74 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[12][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 70 && Number(item.Q4) <= 74 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[13][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 75 && Number(item.Q4) <= 79 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[13][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 75 && Number(item.Q4) <= 79 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[13][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 75 && Number(item.Q4) <= 79 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
                ...
                data[14][`${resident}_${parent}_male`] = result?.filter(item => Number(item.Q4) >= 80 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 1)?.length || 0;
                data[14][`${resident}_${parent}_female`] = result?.filter(item => Number(item.Q4) >= 70 && Number(item.Q36) === idx + 1 && Number(item.Q30) === parentCode && Number(item.Q3) === 2)?.length || 0;
                data[14][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 80 && 
                    [1, 2, 3].includes(Number(item.Q30)) &&
                    [1, 2, 3].includes(Number(item.Q36)) &&
    ...
    try {
        ...
        for(const [reason, reasonCode] of Object.entries(reasons)){
            residentStatus.map((resident, idx) => {
                data[0][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 5 && Number(item.Q4) <= 9 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[0][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 5 && Number(item.Q4) <= 9 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[0][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 5 && Number(item.Q4) <= 9 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                    [1, 2].includes(Number(item.Q3)))?.length || 0;
                    
                data[1][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 10 && Number(item.Q4) <= 14 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[1][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 10 && Number(item.Q4) <= 14 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[1][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 10 && Number(item.Q4) <= 14 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[2][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 15 && Number(item.Q4) <= 19 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[2][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 15 && Number(item.Q4) <= 19 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[2][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 15 && Number(item.Q4) <= 19 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[3][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 20 && Number(item.Q4) <= 24 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[3][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 20 && Number(item.Q4) <= 24 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[3][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 20 && Number(item.Q4) <= 24 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[4][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 25 && Number(item.Q4) <= 29 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[4][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 25 && Number(item.Q4) <= 29 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[4][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 25 && Number(item.Q4) <= 29 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[5][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 30 && Number(item.Q4) <= 34 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[5][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 30 && Number(item.Q4) <= 34 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[5][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 30 && Number(item.Q4) <= 34 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[6][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 35 && Number(item.Q4) <= 39 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[6][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 35 && Number(item.Q4) <= 39 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[6][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 35 && Number(item.Q4) <= 39 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[7][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 40 && Number(item.Q4) <= 44 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[7][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 40 && Number(item.Q4) <= 44 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[7][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 40 && Number(item.Q4) <= 44 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[8][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 45 && Number(item.Q4) <= 49 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[8][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 45 && Number(item.Q4) <= 49 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[8][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 45 && Number(item.Q4) <= 49 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[9][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 50 && Number(item.Q4) <= 54 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[9][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 50 && Number(item.Q4) <= 54 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[9][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 50 && Number(item.Q4) <= 54 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[10][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 55 && Number(item.Q4) <= 59 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[10][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 55 && Number(item.Q4) <= 59 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[10][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 55 && Number(item.Q4) <= 59 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[11][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 60 && Number(item.Q4) <= 64 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[11][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 60 && Number(item.Q4) <= 64 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[11][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 60 && Number(item.Q4) <= 64 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[12][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 65 && Number(item.Q4) <= 69 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[12][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 65 && Number(item.Q4) <= 69 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[12][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 65 && Number(item.Q4) <= 69 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[13][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 70 && Number(item.Q4) <= 74 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[13][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 70 && Number(item.Q4) <= 74 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[13][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 70 && Number(item.Q4) <= 74 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[14][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 75 && Number(item.Q4) <= 79 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[14][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 75 && Number(item.Q4) <= 79 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[14][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 75 && Number(item.Q4) <= 79 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
                ...
                data[15][`${resident}_${reason}_male`] = result?.filter(item => Number(item.Q4) >= 80 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 1)?.length || 0;
                data[15][`${resident}_${reason}_female`] = result?.filter(item => Number(item.Q4) >= 80 && Number(item.Q40A) === reasonCode && Number(item.Q36) === idx + 2 && Number(item.Q3) === 2)?.length || 0;
                data[15][`total`] = result?.filter(item => 
                    Number(item.Q4) >= 80 && 
                    [1, 2, 3, 4, 5].includes(Number(item.Q40A)) &&
                    [1, 2, 3].includes(Number(item.Q36)) && 
