            ...
            result.forEach((res) => {
                if (d.religion === res.Q9) {
                    for (const [migrant, migrantCode] of Object.entries(migrantCodes)) {
                        ...
                        d[`${migrant}Femail`] = result.filter((y) => y.Q9 === d.religion && Number(y.Q36) === migrantCode && Number(y.Q3) === 2).length || 0;
                    }
                }
            });
        });
            ...
            result.forEach((res) => {
                if (d.ethnicity === res.Q10) {
                    for (const [migrant, migrantCode] of Object.entries(migrantCodes)) {
                        ...
                        d[`${migrant}Femail`] = result.filter((y) => y.Q10 === d.ethnicity && Number(y.Q36) === migrantCode && Number(y.Q3) === 2).length || 0;
                    }
                }
            });
        });
...
export const getTableSevenReport = async (req, res) => {
    try {
        ...
        const educationLevel = {
            ...
            juniorHighSchool: 5,
            juniorHighSchoolGraduate: 6,
            seniorHighSchool: 7,
            seniorHighSchoolGraduate: 8,
            vocational: 9,
            college: 10,
            collegeGraduate: 11,
            postGraduate: 12,
        ...
        for (const [education, educationCode] of Object.entries(educationLevel)) {
            residentCodes.map((resident, idx) => {
                data[0][`${resident}${education}Male`] = result.filter(item => Number(item.Q4) >= 5 && Number(item.Q4) <= 9 && Number(item.Q11) === educationCode && Number(item.Q36) === idx + 1 && Number(item.Q3) === 1).length || 0;
                data[0][`${resident}${education}Female`] = result.filter(item => Number(item.Q4) >= 5 && Number(item.Q4) <= 9 && Number(item.Q11) === educationCode && Number(item.Q36) === idx + 1 && Number(item.Q3) === 2).length || 0;
    ...
    try {
        ...
        for (const [enrolled, enrolledCode] of Object.entries(enrolledStatus)) {
            residentCodes?.map((resident, idx) => {
                ...
                data[0][`${resident}${enrolled}Femail`] = result.filter(item => Number(item.Q4) >= 3 && Number(item.Q4) <= 4 && Number(item.Q12) === enrolledCode && Number(item.Q36) === idx + 1 && Number(item.Q3) === 2).length || 0;
                ...
                data[1][`${resident}${enrolled}Femail`] = result.filter(item => Number(item.Q4) >= 5 && Number(item.Q4) <= 9 && Number(item.Q12) === enrolledCode && Number(item.Q36) === idx + 1 && Number(item.Q3) === 2).length || 0;
                ...
                data[2][`${resident}${enrolled}Femail`] = result.filter(item => Number(item.Q4) >= 10 && Number(item.Q4) <= 14 && Number(item.Q12) === enrolledCode && Number(item.Q36) === idx + 1 && Number(item.Q3) === 2).length || 0;
                ...
                data[3][`${resident}${enrolled}Femail`] = result.filter(item => Number(item.Q4) >= 15 && Number(item.Q4) <=19 && Number(item.Q12) === enrolledCode && Number(item.Q36) === idx + 1 && Number(item.Q3) === 2).length || 0;
                ...
                data[4][`${resident}${enrolled}Femail`] = result.filter(item => Number(item.Q4) >= 20 && Number(item.Q4) <= 24 && Number(item.Q12) === enrolledCode && Number(item.Q36) === idx + 1 && Number(item.Q3) === 2).length || 0;
            })
        }
...
export const getTableThirteenReport = async (req, res) => {
    try {
        ...
        data[0][`male`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q19) === 1 && Number(item.Q3) === 1).length || 0;
        data[0][`female`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q19) === 1 && Number(item.Q3) === 2).length || 0;

        data[1][`male`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q19) === 2 && Number(item.Q3) === 1).length || 0;
        data[1][`female`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q19) === 2 && Number(item.Q3) === 2).length || 0;

        data[2][`male`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q19) === 3 && Number(item.Q3) === 1).length || 0;
        data[2][`female`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q19) === 3 && Number(item.Q3) === 2).length || 0;

        data[3][`male`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q19) === 4 && Number(item.Q3) === 1).length || 0;
        data[3][`female`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q19) === 4 && Number(item.Q3) === 2).length || 0;
...
export const getTableFourteenReport = async (req, res) => {
    try {
        ...
        data[0][`male`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 1 && Number(item.Q3) === 1).length || 0;
        data[0][`female`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 1 && Number(item.Q3) === 2).length || 0;

        data[1][`male`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 2 && Number(item.Q3) === 1).length || 0;
        data[1][`female`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 2 && Number(item.Q3) === 2).length || 0;

        data[2][`male`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 3 && Number(item.Q3) === 1).length || 0;
        data[2][`female`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 3 && Number(item.Q3) === 2).length || 0;

        data[3][`male`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 4 && Number(item.Q3) === 1).length || 0;
        data[3][`female`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 4 && Number(item.Q3) === 2).length || 0;

        data[3][`male`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 4 && Number(item.Q3) === 1).length || 0;
        data[3][`female`] = result.filter(item => Number(item.Q4) <= 11 && Number(item.Q20) === 4 && Number(item.Q3) === 2).length || 0;

        data[4][`male`] = result.filter(item => Number(item.Q4) <= 11 && !codes.includes(Number(item.Q20)) && Number(item.Q3) === 1).length || 0;
        data[4][`female`] = result.filter(item => Number(item.Q4) <= 11 && !codes.includes(Number(item.Q20)) && Number(item.Q3) === 2).length || 0;
        ...
        data?.forEach((d) => {
            result.forEach((res) => {
                if (d.immuzation === res.Q21) {
                    d[`male`] = result.filter((y) => y.Q21 === d.immuzation && Number(y.Q4) <= 11 && Number(y.Q3) === 1).length || 0;
                    d[`female`] = result.filter((y) => y.Q21 === d.immuzation && Number(y.Q4) <= 11 && Number(y.Q3) === 2).length || 0;
                }
            });
        });
